...
EM.scenemanager = (function($){
    ...
    function init( id ){
        ...
        imageOptimizer.enableResize = !EM.player.context.isOffline && window.location.href.indexOf('fullsizeimages') === -1;
    ...
    function getPresentationObject(id) {
        ...
        if ( !isStatic ){
            ...
            if (EM.isLayoutsPlayer) {
                ...
                getPresentationData = { presentationID: id, key: getUrlParameter('key') };
            }
            ...
            if ( !EM.player.context.isStatic ){
                ...
                if (EM.playerSettings && EM.playerSettings.checker && EM.playerSettings.checker.isSettingsBrand) {
                    $.ajax({
                        ...
                        error: function (data) {
                            console.error('Player Settings JS file does not exist');
                        },
                    });
